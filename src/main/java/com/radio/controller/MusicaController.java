...
public class MusicaController {
	...
	public Musica updateMusica(@PathVariable(value = "id") Long musicaId, @RequestBody Musica musicaDetails) {
		...
		musica.setCompositor(musicaDetails.getCompositor());
		musica.setAutor(musicaDetails.getAutor());
		musica.setBanda(musicaDetails.getBanda());
		musica.setMusica(musicaDetails.getMusica());
